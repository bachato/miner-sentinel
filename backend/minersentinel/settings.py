"""
Django settings for minersentinel project.
"""
...
ROOT_URLCONF = 'minersentinel.urls'
...
WSGI_APPLICATION = 'minersentinel.wsgi.application'
...
CSRF_COOKIE_SECURE = config('COOKIE_SECURE', default=False, cast=bool)  # Set to True in production with HTTPS
CSRF_USE_SESSIONS = False  # Use cookie-based CSRF tokens

# Session Settings (for SPA authentication)
SESSION_COOKIE_SAMESITE = 'Lax'  # Allow session cookie in same-site requests
SESSION_COOKIE_SECURE = config('COOKIE_SECURE', default=False, cast=bool)  # Set to True in production with HTTPS
